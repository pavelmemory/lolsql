...
type IdStub struct { column }
var IdStubConst IdStub
func Id() *IdStub {return &IdStubConst}
func (*IdStub) Column() string {return "Id"}

type AddressStub struct { column }
var AddressStubConst AddressStub
func Address() *AddressStub {return &AddressStubConst}
func (*AddressStub) Column() string {return "Address"}

type ChildrenStub struct { column }
var ChildrenStubConst ChildrenStub
func Children() *ChildrenStub {return &ChildrenStubConst}
func (*ChildrenStub) Column() string {return "Children"}
